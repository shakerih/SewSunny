...
$(document).ready(function() {
    ...
    $('#btAdd').click(function() {
        ...
        // ADD TEXTBOX.
        $(container).append('<p>Material '+iCnt+'</P> <br><input type="number" name="'+iCnt+'quant" placeholder="enter quantity"><select name="'+iCnt+'units" size="1" placeholder="unit"><option value="pounds">lbs</option><option value="cm">cm</option><option value="meter">meters</option><option value="pcs">pcs</option> <option value="rolls">rolls</option><option value="kg">kg</option><option value="items">items</option><option value="mm">mm</option></select><input type="text" name="'+iCnt+'name" placeholder="material name"><br>');
    ...
    $('#stepAdd').click(function() {
        ...
        // ADD TEXTBOX.
        $(scontainer).append('<p>Step '+sCnt+' </p><textarea name="'+sCnt+'inst"  rows="8" placeholder="Enter instructions here..." ></textarea><p>Image URL</P><input type="text" name="'+sCnt+'url" >');
